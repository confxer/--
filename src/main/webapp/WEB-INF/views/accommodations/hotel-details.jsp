...
<style>
    ...
    .reply_item {
        ...
        border-left: 3px solid #FFD700; /* 노란색 */
        margin-top: 10px;
    }
    .reply_item h5 {
        margin: 0 0 5px;
		...
		<div class="container">
				...
				<div class="container">
					...
					<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
						<div style="display: -webkit-inline-box;">
							...
							<h3 style="margin: 15px 0px 0px 5px;">
								<span class="star"> <i class="icon-star"></i>${a.star_rating}(${a.review_count})
								</span>
							</h3>
						</div>
						<h6 class="rate mb-5">
							<span class="loc"><a href="#"><i class="icon-map"></i>
									${a.address }</a></span> <span class="loc"><a href="#"><i
									class="icon-phone"></i> ${a.phone_number }</a></span>
						</h6>
						<h6>${a.description }</h6>
					</div>
					<!-- 		<div class="row"> -->
											...
											<div class="item">
												<div class="row">
													<div class="col-lg-4 col-sm-5">
														<div class="image">
															<img src="${path}/resources/assets/images/country-01.jpg"
																alt="">
														</div>
													</div>
													<div class="col-lg-8 col-sm-7">
														<div class="right-content">
															...
															<div class="main-button">
																<a
																	href="/reservation?name=${a.accommodation_name }&r_no=${r.room_no}">예약</a>
															</div>
															<p>${r.description }</p>
															<ul class="info">
			...
			<script>
				function bannerSwitcher() {
					next = $('.sec-1-input').filter(':checked').next(
							'.sec-1-input');
					if (next.length)
                ...
                <div class="review_item">
                    ...
                    <div class="reply_item">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5>Owner Reply</h5>
                                <p>Thank you for your feedback! We hope to see you again.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="review_item">
                    ...
                    <div class="reply_item">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5>Owner Reply</h5>
                                <p>We're sorry to hear about your experience. Please contact us to resolve the issue.</p>
                            </div>
                        </div>
                    </div>
                </div>
